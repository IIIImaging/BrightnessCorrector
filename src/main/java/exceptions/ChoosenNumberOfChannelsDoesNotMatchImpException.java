...
public class ChoosenNumberOfChannelsDoesNotMatchImpException extends Exception {
	
	public ChoosenNumberOfChannelsDoesNotMatchImpException() {
		super();
	}
	
	public ChoosenNumberOfChannelsDoesNotMatchImpException(String msg) {
		super(msg);
	}
